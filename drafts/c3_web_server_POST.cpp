...
URI GET : 192.168.4.1/test
URI POST : 192.168.4.1/test

Sdkconfig might need to change 512 values to 1024
...
esp_err_t get_handler(httpd_req_t *req)
{
    ...
    const char footer[] = "/test\" method=\"post\"><label for=\"mytext\">Contenu :</label><textarea id=\"mytext\" name=\"mytext\">text content</textarea> <br/><button>Envoyer POST</button></form></body></html>";
    char response[512] = "";
